...
//   menu: "absolute z-[99999] bg-white border border-gray-300 rounded-md shadow-lg min-w-[12rem]",
...
//   contentClass?: string;
//   maxMenuHeight?: number | string;
//   renderItem?: MultiLevelDropdownProps["renderItem"];
//   depthTriggerClassNames?: string[];
// }
...
// const MultiLevelDropdown: React.FC<MultiLevelDropdownProps> = React.memo(
//   ({
//     label,
//     labelHeader,
//     depthHeader,
...
//     // Calculate menu position with offset
//     // const positionStyle = useMemo(() => {
//     //   const style: React.CSSProperties = {};
//     //   if (position.includes("center")) {
//     //     style.transform = `translate(calc(-50% + ${menuOffset.x}px), ${menuOffset.y}px)`;
//     //   } else {
//     //     if (position.includes("bottom")) {
//     //       style.top = `calc(100% + ${menuOffset.y}px)`;
//     //     } else if (position.includes("top")) {
//     //       style.bottom = `calc(100% + ${menuOffset.y}px)`;
//     //     }
//     //     if (position.includes("left")) {
//     //       style.left = `${menuOffset.x}px`;
//     //     } else if (position.includes("right")) {
//     //       style.right = `${menuOffset.x}px`;
//     //     }
//     //   }
//     //   return style;
//     // }, [position, menuOffset]);
...
//       if (position.includes("center")) {
//         // Preserve -translate-x-1/2 from MAIN_POSITION_CLASSES
//         if (menuOffset.x !== 0 || menuOffset.y !== 0) {
