...
//   showfilter?: boolean;
//   selectFilterLabel?: React.ReactNode;
//   filterLabel?: string;
...
//   // Move paginatedData before handleSelectAll and isAllSelected
//   const paginatedData = useMemo(() => {
//     if (onPageChange || propTotalPages) {
//       return data; // Server-side pagination
//     }
//     const start = (currentPage - 1) * pageSize;
//     return filteredData.slice(start, start + pageSize); // Client-side pagination
//   }, [filteredData, currentPage, pageSize, data, onPageChange, propTotalPages]);

//   const handleSearch = useCallback(() => {
//     setAppliedSearchTerm(searchInput.trim().toLowerCase());
//   }, [searchInput]);
...
//               <Link
//                 href={addLink}
//                 className="inline-flex items-center justify-center rounded-md font-medium transition focus:outline-none focus:ring-0 focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-md bg-white px-2"
//               >
//                 {addLinkLabel}
//               </Link>
//             </>
