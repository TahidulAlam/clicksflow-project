...
const PartnerAnnouncementManageSchema = z.object({
  hideTotalClick: z.boolean().optional(),
  showAccountManagerDetails: z.boolean().optional(),
});

type FormType = z.infer<typeof PartnerAnnouncementManageSchema>;

interface PartnerAnnouncementManageEditProps {
  onSubmitSuccess?: () => void;
  isLoading?: boolean;
}

const PartnerAnnouncementManageEdit: React.FC<
  PartnerAnnouncementManageEditProps
> = ({ onSubmitSuccess, isLoading = false }) => {
  ...
  return (
    <Container>
      <FormArea
        schema={PartnerAnnouncementManageSchema}
        defaultValues={{
...
export default PartnerAnnouncementManageEdit;
