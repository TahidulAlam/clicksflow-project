...
import AdvertiserPortalSettingModal from "./AdvertiserPortalSettingModal";
...
const AdvertiserPortal = () => {
  const [isAdvertiserPortalSetting, setIsAdvertiserPortalSetting] =
    useState(false);
  return (
    <div>
      <BoxAccordion className="w-1/2">
        ...
        >
          ...
          <button
            ...
            onClick={() => setIsAdvertiserPortalSetting(true)}
          >
            <FaPen />
            <span>Edit</span>
          </button>
      ...
      <AdvertiserPortalSettingModal
        isOpen={isAdvertiserPortalSetting}
        onClose={() => setIsAdvertiserPortalSetting(false)}
        onSubmitSuccess={() => {}}
        isLoading={false}
      />
    </div>
