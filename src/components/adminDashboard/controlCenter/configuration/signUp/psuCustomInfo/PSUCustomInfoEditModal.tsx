...
export type PSUCustomInfoEditModalData = z.infer<typeof formSchema>;
...
interface PSUCustomInfoEditModalProps {
  isOpen: boolean;
  isLoading?: boolean;
  onClose: () => void;
  onSubmitSuccess: (data: PSUCustomInfoEditModalData) => void;
  defaultData?: PSUCustomInfoEditModalData;
}
...
const PSUCustomInfoEditModal: React.FC<PSUCustomInfoEditModalProps> = ({
  isOpen,
  isLoading = false,
  onClose,
  onSubmitSuccess,
  ...
  } = useForm<PSUCustomInfoEditModalData>({
  ...
  const onSubmit: SubmitHandler<PSUCustomInfoEditModalData> = async (data) => {
    try {
...
export default PSUCustomInfoEditModal;
