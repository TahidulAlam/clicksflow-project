...
const schema = z.object({
  selectGroup: z.string().min(1, "Account Executive is required"),
...
interface RecipintsGenMessageProps {
  onSubmitSuccess?: () => void;
  isLoading?: boolean;
}

const RecipintsGenMessage: React.FC<RecipintsGenMessageProps> = ({
  onSubmitSuccess,
  isLoading = false,
}) => {
...
export default RecipintsGenMessage;
