...
interface BillingPartnersProps {
  onSubmitSuccess?: () => void;
  isLoading?: boolean;
}

const BillingPartners: React.FC<BillingPartnersProps> = ({
  onSubmitSuccess,
  isLoading = false,
}) => {
    ...
    <Container>
      ...
      >
        {(methods) => {
          ...
          const selectedPaymentMethod = watch("paymentMethods");
            ...
            <>
              <div>
                <div className="grid grid-cols-3 gap-4">
                  ...
                  {/* Other billing frequency fields... (keep your existing implementation) */}
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                {paymentMethodsOptions
                  .find((p) => p.value === selectedPaymentMethod)
              ...
              <h1 className="font-bold text-base my-5">TAX Information</h1>
              ...
              <h1 className="font-bold text-base my-5">Auto Invoicing</h1>
              <div>
                <Controller
